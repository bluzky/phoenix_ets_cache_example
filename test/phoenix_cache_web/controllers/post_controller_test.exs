defmodule PhoenixCacheWeb.PostControllerTest do
  use PhoenixCacheWeb.ConnCase

  alias PhoenixCache.Posts

  @create_attrs %{content: "some content", summary: "some summary", title: "some title"}
  @update_attrs %{content: "some updated content", summary: "some updated summary", title: "some updated title"}
  @invalid_attrs %{content: nil, summary: nil, title: nil}
